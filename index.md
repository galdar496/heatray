...
|Input |Description |
|:---: |:---- |
|baseColor| For dialectics, this represents the albedo color of the surface. For conductors, this represents the specular reflection color. Specified in **linear** space. |
